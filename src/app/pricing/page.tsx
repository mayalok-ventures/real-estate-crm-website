        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              ...
              <div className="inline-flex items-center gap-1 p-1.5 rounded-2xl bg-slate-100 border border-slate-200 text-xs font-mono">
          ...
          <div className="max-w-5xl mx-auto bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-12">
              ...
              <div className="lg:col-span-7 p-6 sm:p-10 space-y-8 bg-slate-50/40 border-b lg:border-b-0 lg:border-r border-slate-200">
              ...
              <div className="lg:col-span-5 p-6 sm:p-10 flex flex-col justify-between space-y-6 bg-white">
                <div className="space-y-6">
                  ...
                  <div className="relative rounded-2xl overflow-hidden border border-slate-200 aspect-[21/9] shadow-inner">
                    <Image
