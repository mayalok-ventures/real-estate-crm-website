...
export const SEED_PAGES: SeoPage[] = [
  ...
  },
  {
    ...
    h1: "Built for How Real Estate Deals Actually Move",
    bodyContent: "10 operational stages of the property sales lifecycle: Universal Webhook Ingress, Instant Distribution, WhatsApp Sales Hub, Follow-Up Cadences, Mobile Field PWA, Show-Flat Logistics, Multi-Tower Inventory Matrices, Milestone Deal Tracking, Event Automation, and Multi-Tenant Security.",
  ...
  },
  {
    ...
    relatedPages: ["page_home", "page_features", "page_contact", "page_pricing"],
    qualityScore: 100,
    qualityIssues: [],
    createdAt: "2026-09-20T00:00:00Z",
    updatedAt: "2026-09-20T00:00:00Z"
  ...
  },
  {
    ...
    secondaryKeywords: ["real estate CRM resources", "real estate sales tools", "real estate WhatsApp scripts", "real estate commission calculator"],
    country: "IN",
    language: "en",
    locale: "en-in",
    title: "Real Estate Sales Resources & Operating Hub | Sahyak CRM",
    metaDescription: "Practical guides, interactive calculators, field checklists, and sales operating resources built for real estate sales teams, brokers, and property developers.",
    h1: "Practical Resources for Running Real Estate Sales Operations",
    bodyContent: "Interactive calculators, migration playbooks, operational solutions, software comparisons, and copyable field templates for real estate sales operations.",
    ...
    relatedPages: ["page_tool_lead_response", "page_tool_commission", "page_tool_real_estate_lead_leakage", "page_tool_real_estate_crm_roi", "page_res_crm_migration", "page_sol_lead_mgmt"],
    qualityScore: 100,
    qualityIssues: [],
    createdAt: "2026-09-20T00:00:00Z",
    updatedAt: "2026-09-20T00:00:00Z"
...
export const SEED_INTERNAL_LINKS: InternalLink[] = [
  ...
  { id: "link_res_tool_leakage_full", sourcePageId: "page_resources", sourcePath: "/resources", targetPageId: "page_tool_real_estate_lead_leakage", targetPath: "/tools/real-estate-lead-leakage-calculator", anchorText: "Real Estate Lead Leakage Calculator", rel: "follow", context: "body", createdAt: "2026-09-20T00:00:00Z" },
  ...
  { id: "link_res_tool_roi_full", sourcePageId: "page_resources", sourcePath: "/resources", targetPageId: "page_tool_real_estate_crm_roi", targetPath: "/tools/real-estate-crm-roi-calculator", anchorText: "Real Estate CRM ROI Calculator", rel: "follow", context: "body", createdAt: "2026-09-20T00:00:00Z" },
  { id: "link_res_tool_pipeline_full", sourcePageId: "page_resources", sourcePath: "/resources", targetPageId: "page_tool_brokerage_pipeline", targetPath: "/tools/brokerage-pipeline-calculator", anchorText: "Brokerage Pipeline Velocity Calculator", rel: "follow", context: "body", createdAt: "2026-09-20T00:00:00Z" },
